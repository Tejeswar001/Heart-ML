      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Cardiovascular Risk Assessment</h1>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Please provide your health information for an accurate risk assessment
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Basic demographic and physical information</CardDescription>
              </CardHeader>
                ...
                {bmi && (
                  <div className="p-4 rounded-lg bg-secondary">
                    <p className="text-sm text-muted-foreground">
                      Calculated BMI: <span className="font-semibold text-foreground">{bmi}</span>
                    </p>
                  </div>
                )}
              </CardContent>
            ...
            <Card className="mt-6">
              <CardHeader>
                ...
                <CardDescription>Recent measurements from your health checkup</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      max="250"
                    />
                    <p className="text-xs text-muted-foreground">Upper number in blood pressure reading</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      max="150"
                    />
                    <p className="text-xs text-muted-foreground">Lower number in blood pressure reading</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="well_above_normal">Well Above Normal</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleInputChange("glucose", value)}
                      required
                    >
          ...
          <div className="mt-8 p-4 rounded-lg bg-muted/50 border border-border">
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Note:</strong> This tool is for informational purposes only and should
              not replace professional medical advice. Always consult with a healthcare provider for medical decisions.
            </p>
          </div>
        </div>
      </div>
